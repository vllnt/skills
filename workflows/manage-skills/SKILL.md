---
name: manage-skills
description: Create, review, update, organize, or retire portable agent skills around a clear outcome and evidence.
---

## Goal

Maintain portable agent skills while consumer repositories retain their own architecture, commands, permissions, and delivery policy.

### Definition of Done

- Outcome, owner, effects, callers, portability boundary, and validation criteria are explicit.
- Assessment and planning change nothing.
- Authorized changes retain valid metadata, callers, scenario evidence, and explicit gaps.
- The skill has the appropriate template, clear contract, and targeted pitfalls where needed.
