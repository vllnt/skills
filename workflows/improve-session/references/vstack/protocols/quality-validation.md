...
4. Collect verdicts and findings with criterion, location or scenario, evidence, impact, smallest remedy, and acceptance check. Before dependent repairs, tie each blocker to the current authorized criteria or a demonstrated regression or safety obligation, including necessary supporting behavior absent from the original issue. Separate evidence of a defect from necessity and authority for its proposed remedy. Honor accepted recovery paths; resolve conflicting requirements rather than silently strengthening or weakening them. Deduplicate into required fixes, selected improvements, optional suggestions, and justified rejections. Resolve disagreements with evidence; a disputed required criterion remains open.
