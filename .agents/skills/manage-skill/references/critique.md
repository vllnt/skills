...
Challenge necessity and instruction cost. Use independent subagents when available, following [coordination](coordination.md).
...
2. Try deletion, reuse, and consolidation before addition. Propose the smallest supported change that preserves required behavior.
3. Return findings in the [required format](coordination.md#finding-format), or accept without changes when none are justified.
